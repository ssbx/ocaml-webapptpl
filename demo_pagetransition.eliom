...
let%shared () =
  Webapptpl_base.App.register ~service:Demo_services.demo_pagetransition
...
let%shared () =
  ...
  in
  Webapptpl_base.App.register ~service:Demo_services.detail_page
    (Webapptpl_page.Opt.connected_page detail_page_handler)
